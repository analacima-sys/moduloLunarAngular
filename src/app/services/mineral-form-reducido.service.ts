// src/app/services/mineral-form-reducido.service.ts
import { Injectable } from '@angular/core';
import { FormBuilder, FormGroup, Validators } from '@angular/forms';
import { TipoRoca, TamanoGrano, Clasificacion, Textura } from '../../types';

@Injectable({ providedIn: 'root' })
export class MineralFormReducidoService {
  ...
  constructor(private fb: FormBuilder) {
    this.formulario = this.fb.group({
      ...
      // Estructura: texto libre (opcional en reducido)
      estructura: [''],
      
      // Forma de los granos: texto libre (opcional en reducido)
      formaGranos: [''],
